...
class CategoryListAdapter(private val products: List<Product>, private val clickListener: CategoryClickListener): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun getItemCount(): Int = products.filter { it.type==1 }.size
}
