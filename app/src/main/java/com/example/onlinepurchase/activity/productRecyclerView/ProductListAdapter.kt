...
class ProductListAdapter(private val products: List<Product>, private val clickListener: ProductClickListener): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun getItemCount(): Int = products.filter { it.type==2 }.size
