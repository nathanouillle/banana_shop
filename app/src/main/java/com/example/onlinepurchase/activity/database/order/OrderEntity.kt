...
val MIGRATION_3_4 = object : Migration(3, 4) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL(
            "CREATE TABLE IF NOT EXISTS `order_table` (`id` INTEGER , `products` TEXT NOT NULL, `nbProduct` INTEGER NOT NULL, `price` REAL NOT NULL, `date` INTEGER NOT NULL, `address` TEXT NOT NULL, `userId` INTEGER, " +
